...
# BulkheadLM one-line installer
# Usage:  curl -fsSL https://raw.githubusercontent.com/Louis-Ph/bulkhead-lm/main/install.sh | sh
#    or:  wget -qO- https://raw.githubusercontent.com/Louis-Ph/bulkhead-lm/main/install.sh | sh

REPO_URL="https://github.com/Louis-Ph/bulkhead-lm.git"
INSTALL_DIR="${BULKHEAD_LM_DIR:-$HOME/bulkhead-lm}"
BRANCH="${BULKHEAD_LM_BRANCH:-main}"
...
if [ -d "$INSTALL_DIR/.git" ]; then
  ...
  say "Cloning BulkheadLM into $INSTALL_DIR ..."
