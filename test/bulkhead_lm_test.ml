...
let tests =
  ...
  ; Alcotest_lwt.test_case
      "config parses line user connector"
      `Quick
      config_load_parses_line_connector_test
  ; Alcotest_lwt.test_case
      "config parses viber user connector"
      `Quick
  ...
  ; Alcotest_lwt.test_case
      "line connector handles text webhook"
      `Quick
      line_connector_handles_text_webhook_test
  ; Alcotest_lwt.test_case
  ...
  ; Alcotest_lwt.test_case
      "persistent connector session survives restart"
      `Quick
      persistent_connector_session_survives_restart_test
  ; Alcotest_lwt.test_case
  ...
  ; Alcotest_lwt.test_case
      "control plane replaces and clears memory session"
      `Quick
      control_plane_replaces_and_clears_memory_session_test
  ; Alcotest_lwt.test_case
  ...
  ; Alcotest_lwt.test_case
      "starter help lists commands alphabetically"
      `Quick
      starter_help_lists_commands_alphabetically_test
  ; Alcotest_lwt.test_case
